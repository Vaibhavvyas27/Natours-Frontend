            ...
            <div className="card-body">
                ...
                <form className="row g-3" onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="card">
                            <img src={images.length>0? URL.createObjectURL(images[0]) : "/img/dummy_tour.png"} height={250} width={200} className="card-img-top" alt="..." />
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="card">
                            <img src={images.length>1? URL.createObjectURL(images[1]) : "/img/dummy_tour.png"} height={250} width={200} className="card-img-top" alt="..." />
                            <div className="card-img-overlay flex-column gap-3 d-flex align-items-center justify-content-center">
                                <h6>second image</h6>
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="card">
                            <img src={images.length>2? URL.createObjectURL(images[2]) : "/img/dummy_tour.png"} height={250} width={200} className="card-img-top" alt="..." />
                            <div className="card-img-overlay flex-column gap-3 d-flex align-items-center justify-content-center">
                                <h6>third image</h6>
